...
router.post('/slides', requireAdmin, uploadImage.single('imageFile'), admin.slidesCreate);
router.post('/slides/:id/update', requireAdmin, uploadImage.single('imageFile'), admin.slidesUpdate);
...
router.post('/settings', requireAdmin, uploadImage.fields([{name:'logoFile',maxCount:1},{name:'footerLogoFile',maxCount:1},{name:'faviconFile',maxCount:1},{name:'backgroundDesktopFile',maxCount:1},{name:'backgroundMobileFile',maxCount:1},{name:'heroBannerFile',maxCount:1}]), admin.settingsUpdate);
