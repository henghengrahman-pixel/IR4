...
router.get('/', async (req,res)=>{
  res.render('pages/home',{
    pageTitle:res.locals.settings.seoTitle || res.locals.settings.metaTitle || res.locals.settings.siteName || 'Prediksi Bola',
    pageDescription:res.locals.settings.seoDescription || res.locals.settings.metaDescription || '',
    activePage:'home',
...
router.get('/live', (req,res)=>res.render('pages/live',{pageTitle:`Live Score • ${res.locals.settings.siteName || 'Prediksi Bola'}`,pageDescription:res.locals.settings.seoDescription || res.locals.settings.metaDescription || '',activePage:'live',styles:['/assets/css/styles.css','/assets/css/live.css'],scripts:['/assets/js/live.js'],bodyClass:''}));
